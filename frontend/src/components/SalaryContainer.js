...
//         // Delete a salary entry using axios
...
//         axiosInstance.put(`/api/salaries/${updatedSalary.id}`, updatedSalary)
//             .then(response => {
//                 // Update the state
//                 const updatedSalaries = salaries.map(salary =>
//                     salary.id === updatedSalary.id ? response.data : salary
//                 );
...
//                         <div className="btn-group">
//
//                             <button type="button" className="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editSalaryModal" onClick={() => handleEditSalary(salary)}>Edit</button>
//                             <button className="btn btn-danger btn-sm" onClick={() => handleDelete(salary.id)}>Delete</button>
//                         </div>
//                     </li>
//                 ))}
...
//                             <button type="button" className="btn btn-primary" onClick={() => handleUpdateSalary(editSalary)}>Save changes</button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
